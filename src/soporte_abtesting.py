...
class Pruebas_parametricas:
    ...
    def comprobar_pvalue(self, pvalor, alpha=0.05):
        ...
        """
        if pvalor < alpha:
            print(f"El p-valor de la prueba es {round(pvalor, 4)}, por lo tanto, hay diferencias significativas entre los grupos.")
        else:
            print(f"El p-valor de la prueba es {round(pvalor, 4)}, por lo tanto, no hay evidencia de diferencias significativas entre los grupos.")
